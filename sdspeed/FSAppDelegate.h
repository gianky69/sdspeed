...
@property (weak) IBOutlet NSTextField *UI_errorMessage;

@property (weak) IBOutlet NSTextField *UI_volumesCapacityGB;
@property (weak) IBOutlet NSTextField *UI_volumesReadOnly;
